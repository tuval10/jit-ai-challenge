import { languageDetectionNode, shouldRetryLanguageDetection } from '../../src/nodes/language-detection.node'
...
describe('Language Detection Node - Full Integration', () => {
  ...
  describe('Real Script Analysis', () => {
    it('should detect Bash language from line_counter.sh', async () => {
      const scriptContent = readFileSync(join(__dirname, '../fixtures/line_counter.sh'), 'utf8')
    ...
    it('should detect Node.js language from vowel_counter.js', async () => {
      const scriptContent = readFileSync(join(__dirname, '../fixtures/vowel_counter.js'), 'utf8')
    ...
    it('should detect Python language from word_reverser.py', async () => {
      const scriptContent = readFileSync(join(__dirname, '../fixtures/word_reverser.py'), 'utf8')
